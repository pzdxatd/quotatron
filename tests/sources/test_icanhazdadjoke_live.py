import pytest
from quotatron.sources.icanhazdadjoke import IcanhazdadjokeSource


@pytest.mark.live
@pytest.mark.asyncio
async def test_icanhazdadjoke_returns_at_least_one_item() -> None:
    items = await IcanhazdadjokeSource().fetch(limit=3)
    ...
    for it in items:
        ...
        assert it.source == "icanhazdadjoke"
