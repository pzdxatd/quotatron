import pytest
from quotatron.sources.programming_quotes import ProgrammingQuotesSource


@pytest.mark.live
@pytest.mark.asyncio
async def test_programming_quotes_returns_at_least_one_item() -> None:
    items = await ProgrammingQuotesSource().fetch(limit=3)
    ...
    for it in items:
        ...
        assert it.source == "programming_quotes"
